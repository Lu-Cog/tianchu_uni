...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"tianchu_uni","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 118:
/*!*****************************************************************************************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/uni_modules/uni-datetime-picker/components/uni-datetime-picker/i18n/index.js ***!
  \*****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 119:
/*!****************************************************************************************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/uni_modules/uni-datetime-picker/components/uni-datetime-picker/i18n/en.json ***!
  \****************************************************************************************************************/
...
/***/ 120:
/*!*********************************************************************************************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/uni_modules/uni-datetime-picker/components/uni-datetime-picker/i18n/zh-Hans.json ***!
  \*********************************************************************************************************************/
...
/***/ 121:
/*!*********************************************************************************************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/uni_modules/uni-datetime-picker/components/uni-datetime-picker/i18n/zh-Hant.json ***!
  \*********************************************************************************************************************/
/*! exports provided: uni-datetime-picker.selectDate, uni-datetime-picker.selectTime, uni-datetime-picker.selectDateTime, uni-datetime-picker.startDate, uni-datetime-picker.endDate, uni-datetime-picker.startTime, uni-datetime-picker.endTime, uni-datetime-picker.ok, uni-datetime-picker.clear, uni-datetime-picker.cancel, uni-datetime-picker.year, uni-datetime-picker.month, uni-calender.SUN, uni-calender.MON, uni-calender.TUE, uni-calender.WED, uni-calender.THU, uni-calender.FRI, uni-calender.SAT, uni-calender.confirm, default */
/***/ (function(module) {
...
/***/ 129:
/*!********************************************************************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/uni_modules/lsj-upload/components/lsj-upload/LsjFile.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
  ...
  /**
    ...
    // 选择文件change
      ...
      if (file) {
        ...
        this.files.set(file.name, { file: file, path: path, name: file.name, size: file.size, progress: 0, type: 'waiting' });
...
/***/ 144:
/*!************************************************************************************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/uni_modules/uni-transition/components/uni-transition/createAnimation.js ***!
  \************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 150:
/*!****************************************************************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 158:
/*!***********************************************************************************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/uni_modules/uni-datetime-picker/components/uni-datetime-picker/util.js ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 21:
/*!***********************************************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/js_sdk/wa-permission/permission.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 22:
/*!***********************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/api/api.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getDocList = getDocList;exports.getDocAct = getDocAct;exports.getDakaInfo = getDakaInfo;exports.getDakaAct = getDakaAct;exports.getDakaList = getDakaList;exports.getHolidayList = getHolidayList;exports.getHolidayDetail = getHolidayDetail;exports.getHolidayAct = getHolidayAct;exports.getHolidayAdd = getHolidayAdd;exports.getFlieAdd = getFlieAdd;exports.getAreaInfo = getAreaInfo;exports.getAreaList = getAreaList;exports.getDictDetail = getDictDetail;exports.getHcancel = getHcancel;exports.getUserInfo = getUserInfo;var _request = _interopRequireDefault(__webpack_require__(/*! ./request.js */ 23));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

function getDocList(data) {
  return _request.default.get('doc/list', data);
}


function getDocAct(data) {
  return _request.default.post('doc/act', data);
}


function getDakaInfo(data) {
  return _request.default.get('daka/info', data);
}


function getDakaAct(data) {
  return _request.default.post('daka/act', data);
}

function getDakaList(data) {
  return _request.default.get('daka/list', data);
}

function getHolidayList(data) {
  return _request.default.get('holiday/list', data);
}

function getHolidayDetail(data) {
  return _request.default.get('holiday/detail', data);
}

function getHolidayAct(data) {
  return _request.default.post('holiday/act', data);
}

function getHolidayAdd(data) {
  return _request.default.post('holiday/add', data);
}

function getFlieAdd(data) {
  return _request.default.post('doc', data);
}

function getAreaInfo(data) {
  return _request.default.get('area/info', data);
}

function getAreaList(data) {
  return _request.default.get('area/plist', data);
}

function getDictDetail(data) {
  return _request.default.get('holiday/cate', data);
}

function getHcancel(data) {
  return _request.default.post('holiday/cancel', data);
}

function getUserInfo(data) {
  return _request.default.get('users/info', data);
}
...
/***/ 23:
/*!***************************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/api/request.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var Url = 'http://tc.iqweb.net/api/';
...
var request = {};
['get', 'post'].forEach(function (methods) {
  request[methods] = function (url, data) {return baseRequest(url, methods, data);};
});var _default =
...
/***/ 5:
/*!***********************************************!*\
  !*** D:/1myProject/天楚/tianchu_uni/pages.json ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
